...
mongoose
  .connect('mongodb+srv://sanyabarakhtin:p3rffuqn@cluster0.vplrrsq.mongodb.net/', {
...
app.post('/messages', upload.single('imageFile'), async (req, res) => {
  try {
    ...
    if (messageType === 'image' && req.file) {
      // Если тип сообщения - изображение и есть файл
      ...
      newMessage = new Message({
        ...
        message: messageText,
        timestamp: new Date(),
        imageData: imageBuffer, // Сохраняем бинарные данные изображения
        imageUrl: req.file.path, // Путь к файлу
      });
